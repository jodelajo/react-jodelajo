  ...
  return (
    <div className={styles["about-container"]}>
      ...
      <p>
        ...
        <p>Na jaren te hebben gewerkt als zelfstandig projectmedewerker bij een maatschappelijke stichting, was ik niet meer gelukkig in mijn werk. Ik had al een opleiding Webdesign afgerond in 2009 waar ik veel plezier aan had beleefd. Al ruim 20 jaar werk ik met Photoshop. </p>
        ...
        <p>Ik vind het snijvlak van design en coderen het allerleukst. Pixelperfect en gebruikersvriendelijk met een karaktervolle uitstraling.</p>
