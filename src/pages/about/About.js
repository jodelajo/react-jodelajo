  ...
  return (
    <div className={styles["about-container"]}>
      ...
      <p>
        ...
        <p>Het afgelopen jaar heb ik mij volledig toegelegd op het ontwikkelen van skills en kennis op het gebied van <span className={styles.accent}>Frontend Development en vormgeving</span>. Ik heb voor voor <span className={styles.accent}>Adobe Photoshop</span>, <span className={styles.accent}>Illustrator</span> en <span className={styles.accent}>InDesign</span> mijn <span className={styles.accent}>MBO-certificaten</span> behaald en momenteel wacht ik op de uitslag van mijn eindopdracht van de opleiding <span className={styles.accent}>Frontend Development</span> aan de <span className={styles.accent}>Novi Hogeschool</span> in Utrecht. Tijdens deze opleiding heb ik mij bekwaamd in de meeste recente versies van <span className={styles.accent}>HTML/CSS</span>, <span className={styles.accent}>Javascript</span> en <span className={styles.accent}>React</span>.</p>
